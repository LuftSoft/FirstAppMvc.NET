...
namespace ASP.NETMVC.Models.Product
{
    ...
    public class CategoryProduct
    {
        ...
        public void ChildCategories(List<int> list, ICollection<CategoryProduct> childCates = null)
        {
            if (childCates == null)
            {
                childCates = this.CategoryChildren;
            }
            foreach (var cate in childCates)
            {
                list.Add(cate.Id);
                ChildCategories(list, cate.CategoryChildren);
            }
        }
